...
apis:
  - name: Plaid API
    description: >-
      Plaid is focused on democratizing financial services through technology.
      We build beautiful consumer experiences, developer-friendly
      infrastructure, and intelligent tools that give everyone the ability to
      create amazing products that solve big problems.
    image: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg
    ...
    properties:
      ...
      - type: OpenAPI
        url: properties/plaid-openapi-original.yml
    aid: plaid:plaid-api
  - name: ' asset report/'
